...
- **Server mod wishlist (TICKET-0089):** regular admins can add publicly browsed Nexus mods to a per-server wishlist without using the saved key. The host can approve and install a request or deny it.
